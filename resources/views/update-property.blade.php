...
<section>
    ...
    <form action="{{ route('update-property', $property->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div>
            ...
            <textarea id="property_desc" name="property_desc">{{ $property->property_desc }}</textarea>
        </div>
        <div>
            <label for="property_location">Lokasi Properti</label>
            <input type="text" id="property_location" name="property_location" value="{{ $property->property_location }}">
        </div>
        <div>
            <label for="property_price">Harga</label>
            <input type="text" id="property_price" name="property_price" value="{{ $property->property_price }}">
        </div>
        <div>
